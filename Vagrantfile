...
Vagrant.configure("2") do |config|
  ...
  config.vm.provision "file", source: "./cc-test.pem", destination: "~/.ssh/cc-test.pem"
  config.vm.provision "file", source: "./cc-test.pem", destination: "/home/vagrant/cc-test.pem"
  ...
  $script = <<-SCRIPT
     chmod go-rwx ~/.ssh/cc-test.pem
     chmod go-rwx /home/vagrant/cc-test.pem
  SCRIPT
